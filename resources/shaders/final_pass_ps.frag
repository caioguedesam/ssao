...
void main()
{
	...
	vec3 light_ambient = ambient_power * light.color;
	...
	vec3 light_diffuse = diffuse_power * light.color;
...
//	outColor = vec4(
//		diff.r * ssao * light.color.r,
//		diff.g * ssao * light.color.g,
//		diff.b * ssao * light.color.b,
//		1);
}